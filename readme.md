...
Initially Signales was forked form [signale](https://github.com/klaussinani/signale) in order to solve [issue with logging levels](https://github.com/klaussinani/signale/issues/96).
